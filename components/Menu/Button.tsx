...
export default function Button({ children }: any) {
  return (
    <Link
      ...
      className="text-black border-t-[1px] border-black group relative hover:text-white hover:border-white text-end md:w-36 xl:text-2xl md:text-xl select-none h-min"
    >
